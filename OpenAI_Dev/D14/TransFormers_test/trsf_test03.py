...
"""
[{'generated_text': '你好，我是一款语言模型， 为 了 验 证 中 国 电 影 语 言 模 型 技 术 是 否 成 熟 以 及 对 语 言 模 型 的 实 际 发 挥 ， 您 可 以 在 上'}]
"""
...
output = generator(
    ...
    max_length=150,#指定生成文本的最大长度。这里的 50 表示生成的文本最多包含 50 个标记（tokens）
...
print(output)
"""
[{'generated_text': '你好，我是一款语言模型， 在 线 模 型 的 设 计 ， 您 有 什 么 建 议 ？ 您 在 线 模 型 的 设 计 ， 一 定 是 要 有 创 新 性 ， 可 以 很 好 的 解 决 语 言 模 型 的 问 题 。 您 的 设 计 的 思 路 是 什 么 ？ 您 对 语 言 模 型 的 设 计 有 什 么 建 议 ？ 您 的 设 计 思 路 是 什 么 ？ 您 有 什 么 建 议 ？ 谢 谢 。 我 们 做 一 个 语 言 模 型 的 设 计 ， 有 三 个 方 面 的 内 容 ： 1. 语 言 模 型 2. 语 言 模 型 3. 语 言 模 型 。 语'}]
"""
