...
"""
任务分解是将一个复杂的任务分解成多个小而简单的步骤的过程，以便更好地理解和处理整个任务。例如，使用“思维步骤”技术，模型被指示逐步思考，将大任务分解为多个可管理的任务，并揭示模型思考过程的解释。这有助于提高模型在复杂任务上的表现。
您刚刚问了关于任务分解的问题。任务分解是将复杂任务分解为多个小步骤的过程，以便更好地处理整个任务。这有助于提高模型在复杂任务上的表现。
"""
