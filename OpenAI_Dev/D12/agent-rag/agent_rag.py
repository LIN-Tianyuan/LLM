...
"""
多步推理型、带检索+判断+改写+记忆能力的问答智能体，
并且具备可视化执行图、自动判断是否使用工具、问题不清晰自动改写、自动检索并生成答案。
"""
"""
用户提问 → Agent 分析 → 判断需不需要检索 → 检索文档 → 判断相关性 → 不相关则改写问题再问 → 相关则生成答案 → 记住对话 → 输出
"""
...
def grade_documents(state) -> Literal["generate", "rewrite"]:
    ...
    # LLM模型
    model = ChatOpenAI(temperature=0, model_name="gpt-4o", streaming=True)
...
'---'
{ 'messages': [ AIMessage(content='', additional_kwargs={'tool_calls': [{'index': 0, 'id': 'call_J2p2JfgjLubODdBb87oS9NNp', 'function': {'arguments': '{"query":"Lilian Weng 深度记忆"}', 'name': 'retrieve_blog_posts'}, 'type': 'function'}]}, response_metadata={'finish_reason': 'tool_calls', 'model_name': 'gpt-4o-2024-08-06', 'system_fingerprint': 'fp_6dd05565ef'}, id='run-afefd6ba-b80d-43e3-aaa1-2f6f1b19770e-0', tool_calls=[{'name': 'retrieve_blog_posts', 'args': {'query': 'Lilian Weng 深度记忆'}, 'id': 'call_J2p2JfgjLubODdBb87oS9NNp', 'type': 'tool_call'}])]}
'\n---\n'
---检查相似性---
---决策: 文档相似---
"Output from node 'retrieve':"
'---'
{ 'messages': [ ToolMessage(content="Weng, Lilian. (Mar 2023). Prompt Engineering. Lil’Log. https://lilianweng.github.io/posts/2023-03-15-prompt-engineering/.\n\nLil'Log\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n|\n\n\n\n\n\n\nPosts\n\n\n\n\nArchive\n\n\n\n\nSearch\n\n\n\n\nTags\n\n\n\n\nFAQ\n\n\n\n\n\n\n\n\n\n      LLM Powered Autonomous Agents\n    \nDate: June 23, 2023  |  Estimated Reading Time: 31 min  |  Author: Lilian Weng\n\nCitation#\nCited as:\n\nWeng, Lilian. (Jun 2023). “LLM-powered Autonomous Agents”. Lil’Log. https://lilianweng.github.io/posts/2023-06-23-agent/.\n\nLLM Powered Autonomous Agents\n    \nDate: June 23, 2023  |  Estimated Reading Time: 31 min  |  Author: Lilian Weng\n\n\n \n\n\nTable of Contents\n\n\n\nAgent System Overview\n\nComponent One: Planning\n\nTask Decomposition\n\nSelf-Reflection\n\n\nComponent Two: Memory\n\nTypes of Memory\n\nMaximum Inner Product Search (MIPS)", name='retrieve_blog_posts', id='2e20d1ac-d5ff-498a-98f6-2fa195fc9e4e', tool_call_id='call_J2p2JfgjLubODdBb87oS9NNp')]}
'\n---\n'
---generate(生成答案)---
"Output from node 'generate':"
'---'
{'messages': ['对不起，我没有找到有关 Lilian Weng 对深度记忆类型的具体看法的信息。']}
'\n---\n'
"""