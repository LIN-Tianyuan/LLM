...
"""
任务分解是将复杂任务分解成多个小而简单的步骤的过程。它可以通过对模型进行提示，如逐步思考或多思考路径来实现，从而帮助模型更好地解决复杂任务。任务分解可以通过LLM进行简单提示、使用特定任务说明或人类输入来完成。
您刚刚问了关于任务分解的问题。任务分解是将复杂任务分解为多个简单步骤的过程，可以通过提示模型逐步思考或多思考路径来实现。
您刚刚提及在抗癌药物发现领域的当前趋势、选择一个靶点、请求一个以这些化合物为目标的支架，并尝试合成这种化合物。
User: 什么是任务分解?

AI: 任务分解是将复杂任务分解成多个小而简单的步骤的过程。它可以通过对模型进行提示，如逐步思考或多思考路径来实现，从而帮助模型更好地解决复杂任务。任务分解可以通过LLM进行简单提示、使用特定任务说明或人类输入来完成。

User: 我刚刚问了什么?

AI: 您刚刚问了关于任务分解的问题。任务分解是将复杂任务分解为多个简单步骤的过程，可以通过提示模型逐步思考或多思考路径来实现。
"""