...
"""
创建了一个带工具调用能力的智能体（Agent），
它能判断用户的问题是否需要用工具，比如“天气查询”，
如果用工具，它会自动调用；否则直接回答。
它还记住了之前的对话内容（比如你问了哪个城市），
并最终可视化成了一张“LangGraph 智能图”！
"""

"""
创建了一个伪装的搜索功能，当被调用时返回天气。
"""
# 定义工具函数，用于代理调用外部工具
@tool
...
"""
用 GPT-4o 模型，并告诉它有个叫 search 的工具，它可以调用。
"""
